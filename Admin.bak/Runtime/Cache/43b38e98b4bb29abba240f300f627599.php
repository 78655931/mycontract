...
function optionprice(days){
	...
	$.getJSON('__URL__/optionprice',{table:'agreement_option','CONFIRMATION':confirmation},function(data){
			...
			$("#optionprices").text(optionprices);
	});
}
...
<div id="er" style="float:right"><?php echo (generateQRfromGoogle($vo["agreement_id"])); ?></div>
</div>
<table width="100%" border="0" >
<tr>
<td colspan="2" rowspan="3"><img src="<?php echo ($brand["BRAND_LOGO_URL"]); ?>"></td>
<td width="15%">名称</td>
<td width="22%"><?php echo ($company["COMPANY_NAME"]); ?></td>
<td width="14%">电话</td>
<td width="20%"><?php echo ($company["PHONE"]); ?></td>
</tr>
<tr>
<td>地址</td>
...
<tr>
<td>合同编号</td>
<td><b><?php echo ($vo["agreement_id"]); ?></b></td>
<td>打印日期</td>
<td><?php echo ($date); ?></td>
</tr>
<tr bgcolor="#CCCCCC">
...
<td width="20%"><?php echo ($vo["REAL_NAME"]); ?></td>
<td width="10%" class="t1">联系电话</td>
<td width="22%"><?php echo ($vo["work_phone"]); ?></td>
<td width="14%" class="t1">驾驶证号码</td>
<td width="19%"></td>
</tr>
<tr>
<td bgcolor="#FFFFFF" class="t1">会员类型</td>
<td><?php echo ($vo["MEMBER_TYPE_NAME"]); ?></td>
<td class="t1">紧急电话</td>
<td><?php echo ($vo["contactphone"]); ?></td>
<td class="t1">准驾车型</td>
<td><?php echo ($vo["vehicletype"]); ?></td>
</tr>
<tr>
...
<td>门店取车</td>
<td class="t1">取车门店</td>
<td><?php echo ($reservation["PICKUP_LOCATION_NAME"]); ?></td>
</tr>
<tr>
<td class="t1">还车时间</td>
...
<td>门店还车</td>
<td class="t1">还车门店</td>
<td><?php echo ($reservation["RETURN_LOCATION_NAME"]); ?></td>
</tr>
<tr>
<td class="t1">租期</td>
<td><?php echo ($vo["BASE_RATE_QTY"]); ?>天</td>
<td>预售权</td>
<td><?php echo ($reservation["DEPOSIT"]); ?></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
<td class="t1">车辆类型</td>
<td><?php echo ($cartype["CAR_TYPE_NAME"]); ?></td>
<td class="t1">品牌型号</td>
...
<td>&nbsp;</td>
<td>小计</td>
<td><?php echo ($vo["MANDATORY_CHARGES"]); ?>元</td>
<td class="charge">&nbsp;</td>
...
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>总金额<span style="float:right" id="total-amt"><?php echo ($vo["TOTAL_PRICE"]); ?>元</span></td>
<td>实际金额</td>
<td><span ><?php echo ($vo["REALTOTAL"]); ?>元</span></td>
</tr>
...
<td><?php echo ($unirule["XHOUR_NEXT_DAY"]); ?>小时</td>
<td class="t1">超天价格</td>
<td> <?php echo ($reservation["XDAY"]); ?>元/天</td>
<td class="t1">超小时价格</td>
<td><?php echo ($reservation["XHOUR"]); ?>元/小时</td>
</tr>
<tr>
<td class="t1">政策详情</td>
<td><?php echo ($unirule["TEXT"]); ?></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
