...
$.fn.extend({
    ...
    $.extend({
        bringBackSuggest: function(args, targetType,div) {
			//$.pdialog.close();
			//$.pdialog.closeCurrent(); 
            //var $box = targetType == "dialog" ? $.pdialog.getCurrent() : navTab.getCurrentPanel();
            var $box = targetType == "dialog" ? $("#"+div): navTab.getCurrentPanel();
        ...
        bringBack: function(args, targetType,div) {
            $.bringBackSuggest(args, targetType,div);
            $.pdialog.closeCurrent();
        }
    });
    $.fn.extend({
